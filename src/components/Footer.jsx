...
const Footer = () => {
  ...
  const socialIcons = [
    ...
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/wealthpoint', // Replace with actual Instagram URL
      svg: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              Securing your Today, Multiplying your Tomorrow. Your trusted partner for financial growth.
            </p>
