...
const ContactForm = () => {
  ...
  return (
    <section id="contact" className="section-padding bg-linear-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Ready to start your financial journey? Fill out the form below and our expert will 
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">Block No.- 5, Nagar Akhada Complex, Near Jain Kalar Samaj Bhavan, Reshimbagh Chowk, Nagpur, Maharashtra 440013</p>
                  </div>
                </div>
              </div>
